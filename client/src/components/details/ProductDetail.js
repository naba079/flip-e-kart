...
const ProductDetail = ({ product }) => {
  ...
  const date = new Date(new Date().getTime() + 5 * 24 * 60 * 60 * 1000);
    const newLocal = <TableCell colSpan={2}>
        <img
            src={adURL}
            style={{ width: 390 }}
            alt="flipkartpoints"
  ...
  return (
    <>
      ...
      <SmallText>
        <Typography>
          <StyledBadge />
          Get extra 20% upto ₹50 on 1 item(s)T&C
        </Typography>
        <Typography>
          <StyledBadge />
        ...
        <Typography>
          <StyledBadge />
          Sign up for Flipcart Pay Later and get Flipcart Gift Card worth ₹100*
          Know More
        </Typography>
        <Typography>
          <StyledBadge />
        ...
        <Typography>
          <StyledBadge />
          No Cost EMI on Bajaj Finsery EMI Card on cart value above ₹2999 T&C
        </Typography>
      </SmallText>
